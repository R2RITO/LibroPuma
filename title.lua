...
function scene:create( event )
	...
	background2 = display.newImageRect( sceneGroup, "PumaArbol.jpg", 2000, 1124 )
	...
	pageText.y = display.contentHeight - (display.contentHeight*0.30)

	-- Add more text
	local pageText2 = display.newText( "El Puma Chileno", 0, 0, native.systemFont, 40 )
	pageText2.x = display.contentWidth * 0.5
	pageText2.y = display.contentHeight - (display.contentHeight*0.35)		
